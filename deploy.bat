@echo off
REM SparkDo - GitHub Pages Deployment Script for Windows
...
REM Create docs directory for GitHub Pages (if using docs folder)
if not exist "docs" mkdir docs

REM Copy web build to docs directory
